#############################################################################
# Makefile for building: project3.out
# Generated by qmake (3.0) (Qt 5.0.1) on: Thu Aug 29 19:29:06 2013
# Project:  project3.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile project3.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -I. -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
SOURCES       = main.cpp \
		Window.cpp \
		Board.cpp \
		BoardDragBox.cpp moc_Window.cpp
OBJECTS       = main.o \
		Window.o \
		Board.o \
		BoardDragBox.o \
...
Makefile: project3.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/project3.out1.0.0 || $(MKDIR) .tmp/project3.out1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/project3.out1.0.0/ && $(COPY_FILE) --parents Window.h Board.h BoardDragBox.h .tmp/project3.out1.0.0/ && $(COPY_FILE) --parents main.cpp Window.cpp Board.cpp BoardDragBox.cpp .tmp/project3.out1.0.0/ && (cd `dirname .tmp/project3.out1.0.0` && $(TAR) project3.out1.0.0.tar project3.out1.0.0 && $(COMPRESS) project3.out1.0.0.tar) && $(MOVE) `dirname .tmp/project3.out1.0.0`/project3.out1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/project3.out1.0.0
...
moc_Window.cpp: /usr/include/qt5/QtWidgets/QMainWindow \
		...
		Window.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) Window.h -o moc_Window.cpp
...
Window.o: Window.cpp /usr/include/qt5/QtGui/QtGui \
...
BoardDragBox.o: BoardDragBox.cpp BoardDragBox.h \
		/usr/include/qt5/QtWidgets/QGraphicsItem \
		/usr/include/qt5/QtWidgets/qgraphicsitem.h \
		/usr/include/qt5/QtCore/qglobal.h \
		/usr/include/qt5/QtCore/qconfig.h \
		...
		/usr/include/qt5/QtGui/qfont.h \
		/usr/include/qt5/QtGui/qfontmetrics.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o BoardDragBox.o BoardDragBox.cpp
